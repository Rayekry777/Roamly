...
public class MerchantAuditServiceImpl implements MerchantAuditService {
    ...
    public MerchantAuditServiceImpl(OperationAuditLogWriter writer) {
        this.writer = writer;
    }
        ...
        TransactionSynchronizationManager.registerSynchronization(new TransactionSynchronization() {
            ...
            public void afterCompletion(int status) {
                ...
                OperationAuditLog rolledBack = copy(requested)
                        .setResult(FAILED)
                        .setReason(SUCCEEDED.equals(requested.getResult()) ? "业务事务已回滚" : requested.getReason());
    ...
    private void writeSafely(OperationAuditLog auditLog) {
        try {
            ...
            log.error(
                    "[商户审计] 审计写入失败，action={}，objectType={}，result={}",
                    auditLog.getAction(),
