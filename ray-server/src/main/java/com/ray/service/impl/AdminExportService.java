...
public class AdminExportService {
    ...
    public byte[] export(String resource) {
        ...
        String[] fields = switch (normalized) {
            ...
            case "redemptions" -> { admin.requirePermission(AdminPermissions.TRADE_READ); yield new String[]{"id","voucherId","shopId","merchantAccountId","useCount","status","redeemedTime","reversedTime","reversalReason"}; }
