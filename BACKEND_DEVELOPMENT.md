...
| 2026-09-04 | 后端默认测试 | 120 项中 103 项通过、17 项按条件跳过，0 失败；默认运行未重建数据库 |
| 2026-09-04 | 数据库 Demo | 22 张业务表真实重建；5 项数据库闭环通过并恢复纯种子状态 |
| 2026-09-04 | 运行时 HTTP/OpenAPI | 69 个唯一操作、全部 `$ref`、Knife4j、三域 Token 和管理/商户错误响应共 8 项通过 |
