...
|---:|---|:---:|:---:|:---:|:---:|---|
| [15](../stages/STAGE_15_FOUR_END_CONTRACT_AND_FOUNDATION.md) | 四端契约、仓库与设计基线 | 是 | 是 | 是 | 是 | 未实现 |
| [16](../stages/STAGE_16_ADMIN_AUTH_ACCOUNT_AUDIT.md) | 兼容基础、管理员认证、账号和事务审计 | 是 | 否 | 否 | 是 | 开发中 |
| [17](../stages/STAGE_17_MERCHANT_AUTH_PROFILE.md) | 商户认证、账号状态与“我的” | 是 | 否 | 是 | 否 | 未实现 |
| [18](../stages/STAGE_18_BUSINESS_MEDIA_AND_ONBOARDING.md) | 经营媒体、对象存储和商户入驻 | 是 | 否 | 是 | 否 | 未实现 |
